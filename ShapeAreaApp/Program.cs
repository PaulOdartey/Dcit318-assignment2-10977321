...
namespace ShapeAreaApp
{
    class Program
    {
        ...
        {
            Console.WriteLine("Welcome To DCIT318 Shape Area App");
            Console.WriteLine("This program calculates areas of different shapes .");
            Console.WriteLine();
            ...
            while (continueGenerating)
            {
                ...
                if (userResponse != "yes")
                {
                 ...
                 Console.WriteLine("calculation completed. Press any key to Exit.");
